...
<style>
    * {
    ...
    .sidebarshow .container {
        /* Sesuaikan dengan padding yang diinginkan saat sidebar terbuka */
        padding-left: 255px;
    }
</style>
...
<body>
    ...
    <div class="container h-100">
        ...
        <div class="isi">
            <h3>Semangat Bekerja :)<br />

                <br />
                <a href="../harga/paket_index.php" class="btn btn-primary mb-2">Harga</a>
                <a href="pelanggan.php" class="btn btn-primary mb-2">Pelanggan</a>
                <a href="nota.php" class="btn btn-primary mb-2">Nota Pelanggan</a>
                <a href="transaksi.php" class="btn btn-primary mb-2">Status Transaksi</a>
