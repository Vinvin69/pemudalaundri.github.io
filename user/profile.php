...
// Pastikan pengguna sudah login sebelum dapat mengakses halaman profile
...
$query = "SELECT username, nama_pelanggan, jenis_kelamin, telp, alamat, password FROM pembeli WHERE id_pelanggan = '$user_id'";
